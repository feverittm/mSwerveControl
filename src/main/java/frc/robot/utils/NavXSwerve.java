...
public class NavXSwerve extends SwerveIMU {
  ...
  /**
   * Constructor for the NavX swerve on the MXP connector using SPI Bus
   *
   * @param port Serial Port to connect to.
   */
  public NavXSwerve(SPI.Port port) {
    try {
      /* Communicate w/navX-MXP via the MXP Serial Bus. */
  ...
  /**
   * Constructor for the NavX swerve on the MXP connector over the Serial Bus.
   *
   * @param port Serial Port to connect to.
   */
  ...
  public void factoryDefault() {
    ...
    offset = new Rotation3d(new Quaternion((0.5 * gyro.getQuaternionW()),
        (0.5 * gyro.getQuaternionX()),
        (0.5 * gyro.getQuaternionY()),
        (0.5 * gyro.getQuaternionZ())));
  }
  ...
  public Rotation3d getRawRotation3d() {
    return new Rotation3d(new Quaternion(0.5 * gyro.getQuaternionW(),
        0.5 * gyro.getQuaternionX(),
        0.5 * gyro.getQuaternionY(),
        0.5 * gyro.getQuaternionZ()));
  }
